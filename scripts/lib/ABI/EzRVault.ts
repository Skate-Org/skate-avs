export const EzSKATE = "0xc12e4d31e92cedc1ad4c8c23dbce2c5f7cb52998";
export const EzRVault_ABI = [
  { inputs: [], name: "AlreadyDelegated", type: "error" },
  { inputs: [], name: "EarlyClaim", type: "error" },
  { inputs: [], name: "EarlyCooldownBlocksUpdate", type: "error" },
  { inputs: [], name: "ExceedMaxCooldownBlocks", type: "error" },
  { inputs: [], name: "InvalidFee", type: "error" },
  { inputs: [], name: "InvalidMaxCooldownBlocksBasisPoints", type: "error" },
  { inputs: [], name: "InvalidStrategy", type: "error" },
  { inputs: [], name: "InvalidTokenAmount", type: "error" },
  { inputs: [], name: "InvalidTokenSweep", type: "error" },
  ...
  { inputs: [], name: "InvalidZeroBalance", type: "error" },
  { inputs: [], name: "InvalidZeroInput", type: "error" },
  { inputs: [], name: "NotPauser", type: "error" },
  { inputs: [], name: "NotRewardsProofSubmitter", type: "error" },
  { inputs: [], name: "RewardsDestinationNotConfigured", type: "error" },
  { inputs: [], name: "UnAuthorizedClaimer", type: "error" },
  { inputs: [], name: "UserWithdrawalAlreadyTracked", type: "error" },
    ...
    inputs: [
      {
        indexed: false,
        internalType: "address",
        name: "oldRewardsProofSubmitter",
        type: "address",
      },
      {
        indexed: false,
        internalType: "address",
        name: "newRewardsProofSubmitter",
        type: "address",
      },
    ],
    name: "RewardsProofSubmitterUpdated",
    type: "event",
  },
  {
    anonymous: false,
    ...
    inputs: [
      {
        indexed: false,
        internalType: "address",
        name: "oldRewardsDestination",
        type: "address",
      },
      {
        indexed: false,
        internalType: "address",
        name: "newRewardsDestination",
        type: "address",
      },
    ],
    name: "VaultRewardsDestinationUpdated",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    name: "emergencyTrackSlashedQueuedWithdrawalDelta",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_cooldownBlocks", type: "uint256" },
      ...
      { internalType: "address", name: "_rewardsDestination", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [],
    name: "maxCooldownBlocksBasisPoints",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "bytes32", name: "", type: "bytes32" }],
    name: "queuedWithdrawalInfo",
    outputs: [
      { internalType: "uint256", name: "sharesSlashedDelta", type: "uint256" },
      {
        internalType: "uint256",
        name: "initialWithdrawableShares",
        type: "uint256",
      },
    ],
    stateMutability: "view",
  ...
  {
    inputs: [
      { internalType: "bytes32[]", name: "withdrawRoots", type: "bytes32[]" },
      {
        internalType: "uint256[]",
        name: "initialWithdrawableShares",
        type: "uint256[]",
  ...
  },
  {
    inputs: [
      {
        internalType: "address",
        name: "_rewardsProofSubmitter",
        type: "address",
      },
    ],
    name: "setRewardsProofSubmitter",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  {
    inputs: [],
    name: "totalQueuedSharesSlashedDelta",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "address", name: "withdrawer", type: "address" },
      { internalType: "uint256", name: "lpTokenAmountLocked", type: "uint256" },
