...
const MESSAGE_BOX_ADDRESS = "0xAf6257d774Ac84cd749f1f47207A9FFe575E12B1"
const STAGING_MESSAGE_BOX_ADDRESS = "0x8926c029423B1e9D7af9D0B93C0C2cf5354Dc998"

export function messageBoxFromMode(mode: EnvMode) {
  const address = mode == "PRODUCTION" ? MESSAGE_BOX_ADDRESS : STAGING_MESSAGE_BOX_ADDRESS;
