export const AttestationCenter_ABI = [
  {
    inputs: [
      {
  ...
  {
    inputs: [],
    name: "EigenRewardsDurationExceedsMaximum",
    type: "error",
  },
  {
    inputs: [],
    name: "EigenRewardsDurationNotMultipleOfInterval",
    type: "error",
  },
  {
    inputs: [
    ...
    name: "EigenRewardsMaxRewardsAmountExceeded",
    type: "error",
  },
  {
    inputs: [],
    name: "EigenRewardsMustBeRetroactive",
    type: "error",
  },
  {
    inputs: [],
    name: "EigenRewardsNotSupportedOnL2",
    type: "error",
  },
  {
    inputs: [],
    name: "EigenRewardsStartTimestampNotMultipleOfInterval",
    type: "error",
  },
  {
    inputs: [],
    name: "EigenRewardsStartTimestampTooFarInPast",
    type: "error",
  },
  {
    inputs: [],
  ...
  },
  {
    ...
    name: "InsufficientVotingPowerForTaskDefinition",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "InvalidMaximumNumberOfAttesters",
    type: "error",
  },
  {
    inputs: [],
  ...
  },
  {
    ...
    name: "InvalidRestrictedAttester",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "getActiveOperatorsDetails",
    outputs: [
      {
        components: [
          {
        ...
        internalType: "struct IAttestationCenter.OperatorDetails[]",
        name: "_operators",
        type: "tuple[]",
      },
    ],
  ...
  },
  {
    ...
    name: "getTaskDefinitionMaximumNumberOfAttesters",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "getTaskDefinitionRestrictedAttesters",
    outputs: [
      {
        internalType: "uint256[]",
        name: "",
    ...
    inputs: [
      {
        ...
        internalType: "struct IAttestationCenter.InitializationParams",
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IInternalTaskHandler",
        name: "",
        type: "address",
      },
    ],
  ...
  {
    inputs: [],
    name: "nextEigenRewardsBatchStartTimestamp",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: "struct IAttestationCenter.BlsTaskSubmissionDetails",
        name: "_blsTaskSubmissionDetails",
        type: "tuple",
      },
    ],
    name: "submitTask",
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: "struct IAttestationCenter.EcdsaTaskSubmissionDetails",
  ...
  },
  {
    ...
    name: "verifyOperatorValidForTaskDefinition",
    outputs: [],
    stateMutability: "view",
    type: "function",
  },
